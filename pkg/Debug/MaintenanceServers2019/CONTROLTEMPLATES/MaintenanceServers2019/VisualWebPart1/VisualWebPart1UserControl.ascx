<%@ Assembly Name="MaintenanceServers2019, Version=1.0.0.0, Culture=neutral, PublicKeyToken=4ea1eb0a38b57050" %>
...
<asp:Table id="Table1" runat="server"
    ...
    <asp:TableRow>
        <asp:TableCell>
            <asp:Label ID="Label4" runat="server" Text="Norilsk:"></asp:Label>
            <asp:CheckBoxList ID="CheckBoxList_Norilsk" runat="server" Font-Size="Small">
                <asp:ListItem Text=vnrzfex1901>vnrzfex1901</asp:ListItem>
                <asp:ListItem Text=vnrzfex1902>vnrzfex1902</asp:ListItem>
            </asp:CheckBoxList>
            <asp:Label ID="Label3" runat="server" Text="Talankh:"></asp:Label>
            <asp:CheckBoxList ID="CheckBoxList_Talnakh" runat="server" Font-Size="Small">
                <asp:ListItem Text=vntzfex1901>vntzfex1901</asp:ListItem>
                <asp:ListItem Text=vntzfex1902>vntzfex1902</asp:ListItem>
            </asp:CheckBoxList>
        </asp:TableCell>
